...
The current bootstrap includes immutable source configuration copies and Luna
targets, a Nemotron-sized V4-Flash-inspired reference attention stack with
partial RoPE, sinks, shared KV, configurable index top-k, grouped low-rank
output and mHC, a multimodal model shell, data governance utilities, resumable
stage tooling, a GCP budget guard, a local 4060 profile, and correctness tests.
